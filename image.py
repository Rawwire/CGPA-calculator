...
def img(uploaded_file):
    ...
    # Convert the sharpened image back to PIL format for Tesseract OCR
    ...
    # Define patterns for grades and credits
    pf = ["P", "F", "W", "p", "f", "w"]
